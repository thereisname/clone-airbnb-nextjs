  ...
  return (
    <div className="py-6">
      <header className="font-semibold text-2xl mb-4">최고 수준의 숙소</header>
        ...
        <div
        onClick={handleClick}
        className={`transform transition-all duration-100 ease-in-out border-solid border-2 border-gray-100 hover:border-black p-4 rounded-lg cursor-pointer ${isBest ? 'border-black bg-gray-100' : 'border-gray-300'} ${isClicked ? 'scale-95' : 'scale-100'}`}
