const LoginModal = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    <div className='fixed inset-0 flex items-center justify-center z-50' onClick={onClose}>
      ...
      {/* z-index 추가 */}
      <div
        className='bg-white p-4 rounded shadow-lg max-w-md w-full z-50'
      ...
      >
        ...
        <hr className='my-4' />
        <button className='bg-green-500 text-white py-2 px-4 rounded mb-2 w-full'>
          네이버로 로그인하기
        </button>
        <button className='bg-blue-500 text-white py-2 px-4 rounded mb-2 w-full'>
          페이스북으로 로그인하기
        </button>
        <button className='bg-red-500 text-white py-2 px-4 rounded mb-2 w-full'>
          구글로 로그인하기
        </button>
        <button className='bg-black text-white py-2 px-4 rounded mb-2 w-full'>
          애플로 로그인하기
        </button>
        <button className='bg-gray-500 text-white py-2 px-4 rounded w-full'>
          이메일로 로그인하기
        </button>
      </div>
    </div>
